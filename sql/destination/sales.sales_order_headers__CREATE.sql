...
(
    ...
    credit_card_approval_code character varying(15) COLLATE pg_catalog."default" NOT NULL,
    currency_rate_id integer NOT NULL,
    subtotal decimal(18,2) NOT NULL DEFAULT 0.00,
    tax_amount decimal(18,2) NOT NULL DEFAULT 0.00,
    freight decimal(18,2) NOT NULL DEFAULT 0.00,
    total_due decimal(18,2) GENERATED ALWAYS AS (COALESCE((subtotal + tax_amount)+freight,0.00)) STORED,
